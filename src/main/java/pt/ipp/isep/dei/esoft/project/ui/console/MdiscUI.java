...
public class MdiscUI implements Runnable {
     ...
     * @param workFile
     */
    private static void applyKruskalAlgorythmAndPrintData(List<Edge> edges, String workFile) {
        //US13
     ...
     * @throws FileNotFoundException
     */
    private static List<Edge> readGraphDataFromFile(String testFile) throws FileNotFoundException {
        String[] aux;
